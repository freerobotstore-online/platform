# FreeRobotStore Brand Guidelines

## Mission

FreeRobotStore is an open platform for browser-based AI tools — libraries, models, and agents that run on the user's hardware. Free forever, fully private, open source. No cloud inference cost, no subscription, no tracking.
...
- **FreeRobotStore** — written as one word with "Agent" highlighted in accent purple
...
### Footer (all pages)
```
FreeRobotStore · Docs · GitHub · Pro
FreeStore Family: FreeAppStore | FreeGameStore | FreeWebStore | FreeRobotStore
```
...
| **FreeRobotStore** | **Purple `#7c3aed`** | **A** | **freerobotstore.online** |
