 ...
 * 2. Hosted: config stored in FRS D1, loaded by instance ID (live updates)
 *
 * Training flow:
...
/**
 * Load a hosted agent instance config from the FRS API.
 */
export async function loadAgentConfig(
  baseAgent: string,
  instanceId: string,
  apiBase = 'https://api.freerobotstore.online',
): Promise<AgentConfig> {
