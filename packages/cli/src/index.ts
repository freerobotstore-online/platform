...
const program = new Command()
  .name('frs')
  .description('FreeRobotStore CLI — scaffold, check, and publish browser AI agents.')
  .version('0.2.0');
...
program
  .command('publish')
  .description('Publish agent to FreeRobotStore (creates repo, pushes code, registers route)')
