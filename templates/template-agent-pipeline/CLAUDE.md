...
A **pipeline** heuristic agent on [FreeRobotStore](https://freerobotstore.online).
...
[Trainer](https://freerobotstore.online/a/trainer/). Train the classifier
...
Push to main = auto-deploy to https://freerobotstore.online/a/AGENTNAME/
